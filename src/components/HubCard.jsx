...
const HubCard =  (props) =>{
    ...
    useEffect(() => {
        ...
        switch(props.type){
            ...
            break;
            case 'tournaments':
                axios.get('http://localhost:' +  process.env.IPORT + 'players/tournamentListings/' + encodeURIComponent(props.player.gamerTag))
                .then(res => {
            ...
            break;
            case 'rivals':
                axios.get('http://localhost:' +  process.env.IPORT + 'players/rivals/' + encodeURIComponent(props.player.gamerTag))
                .then(res => {
