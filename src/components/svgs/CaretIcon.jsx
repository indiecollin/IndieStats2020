...
`;
 ...
 export default class CaretIcon extends Component{
    render(){
        return (                                    
            <SVG viewBox="0 0 292.362 292.362" fill = {this.props.fill} dims = {this.props.dims} className={this.props.className}>       
