...
const HubCard =  (props) =>{
    ...
    useEffect(() => {
        ...
        switch(props.type){
            ...
            break;
            case 'tournaments':
                axios.get('http://localhost/api/players/tournamentListings/' + encodeURIComponent(props.player.gamerTag))
                .then(res => {
            ...
            break;
            case 'rivals':
                axios.get('http://localhost/api/players/rivals/' + encodeURIComponent(props.player.gamerTag))
                .then(res => {
