...
const HubCard =  (props) =>{
    ...
    useEffect(() => {
        ...
        switch(props.type){//sets hub card content when player changes
            ...
            break;
            case 'tournaments':
                axios.get('https://' + process.env.DOMAIN + '/api/players/tournamentListings/' + encodeURIComponent(props.player.gamerTag))
                .then(res => {
            ...
            break;
            case 'rivals':
                axios.get('https://' + process.env.DOMAIN + '/api/players/rivals/' + encodeURIComponent(props.player.gamerTag))
                .then(res => {
